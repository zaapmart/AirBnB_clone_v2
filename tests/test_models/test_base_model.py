...
class Test_docstrings(unittest.TestCase):
    ...
    def setup_class(self):
        ...
        pairs sorted according to name
        it's only members for which the predicate returs a true value are includd
        """
        self.obj_members(BaseModel, inspect.isfunction)


class TestBaseModel(unittest.TestCase):
    """it will test the base model class x"""
    ...
    @classmethod
    def teardown(cls):
        """at the end of the testing this will tear it down"""
        del cls.base
    ...
    def test_method_BaseModel(self):
        """chek if Basemodel have methods"""
