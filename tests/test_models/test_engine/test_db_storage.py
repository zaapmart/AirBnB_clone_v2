#!/usr/bin/python3
"""
It contains the Test Database StorageDocs and Test Database Storage classes
"""
...
class TestDBStorageDocs(unittest.TestCase):
    """Testing to check the documentation and style of Database Storage class"""
    @classmethod
    def setUpClass(cls):
        """Set_up for the documentation tests"""
...
class TestDBStorageDocs(unittest.TestCase):
    """Tests to check the doc and style of DBStorage class"""
    @classmethod
    def setUpClass(cls):
        """Set_up for the documentation tests"""
        cls.dbs_f = inspect.getmembers(DBStorage, inspect.isfunction)
